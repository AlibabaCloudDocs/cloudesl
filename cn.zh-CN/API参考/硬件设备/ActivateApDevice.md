...
[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/#product=cloudesl&api=ActivateApDevice&type=RPC&version=2020-02-01)
...
```
http(s)://cloudesl.cn-hangzhou.aliyuncs.com/?Action=ActivateApDevice
